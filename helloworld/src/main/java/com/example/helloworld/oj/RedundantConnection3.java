...
public class RedundantConnection3 {
    ...
    public static void main(String[] args) {
        RedundantConnection3 redundantConnection2 = new RedundantConnection3();
    ...
    public int[] findRedundantDirectedConnection(int[][] edges) {
        // 然后从现在开始一直往前都不认大哥试试
        for (int ignoreIndex = edges.length; ignoreIndex >= 0; ignoreIndex--) {
            if (findRedundantDirectedConnection(edges, ignoreIndex)) {
     ...
     * @return
     */
    public boolean findRedundantDirectedConnection(int[][] edges, int ignoreIndex) {
