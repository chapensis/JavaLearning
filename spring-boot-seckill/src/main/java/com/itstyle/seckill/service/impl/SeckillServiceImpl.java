...
public class SeckillServiceImpl implements ISeckillService {
    ...
    public void deleteSeckill(long seckillId) {
        ...
        nativeSql = "UPDATE seckill SET number =3 WHERE seckill_id=?";
        dynamicQuery.nativeExecuteUpdate(nativeSql, new Object[]{seckillId});
    }
     ...
     */
    @Override
    //@ServiceLimit // 这个是限流策略
    @Transactional
    public Result startSeckil(long seckillId, long userId) {
        // 校验库存,添加for update关键字可以防止超卖，但是会影响性能
     ...
     * 加程序锁还不如添加for update,耗时379ms，方法外程序锁耗时1079ms
     *
     * @param seckillId seckillId
     * @param userId    userId
     * @return Result
    ...
    public Result startSeckilLock(long seckillId, long userId) {
        try {
            ...
            // 由于你解锁后，别人会进来，但是你的事务还没提交，所以库存在别人看来是没有减少的
            lock.unlock();
        }
        return Result.ok(SeckillStatEnum.SUCCESS);
    }
    ...
    /**
     * 加AOP程序锁还不如添加for update,耗时379ms，方法外程序锁耗时1079ms
     * @param seckillId seckillId
     * @param userId userId
     * @return
     */
    ...
    public Result startSeckilDBPCC_TWO(long seckillId, long userId) {
        System.out.println("startSeckilDBPCC_TWO, seckillId: " + seckillId + " userId: " + userId);
