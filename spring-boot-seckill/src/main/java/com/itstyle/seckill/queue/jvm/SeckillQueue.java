...
public class SeckillQueue {
     ...
     *
     * @param kill
     * @throws InterruptedException add(e) 队列未满时，返回true；队列满则抛出IllegalStateException(“Queue full”)异常——AbstractQueue
    ...
    /**
     * 消费出队
     * poll() 获取并移除队首元素，在指定的时间内去轮询队列看有没有首元素有则返回，否则超时后返回null
